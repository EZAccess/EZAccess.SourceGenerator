...
/// </summary>
public partial class ViewColumnDef : IColumnDef, ICloneable
{
	// Functional info
	...
	/// <summary>
	/// Length of the field for variable length fields
	/// </summary>
	...
	// Validation info. Even though views don't need validation for input fields, it can be useful for the front-end.
